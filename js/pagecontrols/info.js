...
underpin.pagecontrols.info = $.klass(underpin.pagecontrols.base, {
	...
	load : function(){
		var txt = $('<div>',{'class' : 'grid_16', 'style' : 'font-size:10pt;'}).appendTo(this.parameters.container);
		txt.html(
			'Hello, Welcome to Underpin.'+
			'<br><br>'+
			'Underpin is a structured framework for front-end development which accelerates the process of setting up a scalable architecture to support dynamic web applications. Through the use of object oriented design a variety of site navigation styles can be implemented. Using backbone.js for navigation and views along with dynamically designed page controllers and subpage controllers allows for easy navigation and dom manipulation.'+
			'<br><br>'+
